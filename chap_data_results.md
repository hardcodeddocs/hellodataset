# Research Dataset Tables and Results for Lalmonirhat Airfield Study

## 1. Survey Questionnaire and Data Collection Methods

### 1.1 Survey Instruments and Target Respondents

| Survey Instrument | Target Respondents | Sample Size | Data Collection Method | Duration | Analysis Method |
|-------------------|-------------------|-------------|------------------------|----------|----------------|
| Stakeholder Perception Survey | Aviation experts, Civil aviation officials, Regional business owners, Local residents | 150 | Face-to-face interviews, Online surveys | 3 months | Mixed methods (qualitative and quantitative) |
| Infrastructure Assessment Survey | Civil engineers, Aviation infrastructure experts, Airfield operations personnel | 50 | On-site assessments, Technical interviews | 2 months | Technical analysis, Gap analysis |
| Economic Impact Survey | Local businesses, Tourism operators, Regional economic development agencies | 100 | Structured interviews, Focus groups | 2.5 months | Economic impact analysis, SWOT analysis |
| Regulatory Framework Analysis | Civil aviation regulators, Policy experts, Legal consultants | 30 | In-depth interviews, Document analysis | 2 months | Comparative analysis, Policy review |

### 1.2 Detailed Questionnaires

#### 1.2.1 Stakeholder Perception Survey Questionnaire

| Section | Question | Response Type | Variables Measured |
|---------|----------|--------------|-------------------|
| Demographics | 1. Please indicate your stakeholder group: (a) Aviation expert (b) Civil aviation official (c) Business owner (d) Local resident (e) Other | Multiple choice | Respondent category |
| | 2. How long have you been associated with or living in the Lalmonirhat region? | Numeric (years) | Regional familiarity |
| | 3. What is your level of awareness about the Lalmonirhat Airfield? | 5-point Likert scale | Awareness level |
| Perception of Opportunities | 4. How would you rate the potential economic benefits of activating Lalmonirhat Airfield? | 5-point Likert scale | Economic perception |
| | 5. Which sectors do you believe would benefit most from airfield activation? | Multiple choice with ranking | Sector prioritization |
| | 6. How would activating the airfield impact tourism in the region? | 5-point Likert scale | Tourism impact perception |
| Perception of Challenges | 7. What do you consider the most significant barriers to activating the airfield? | Ranking of options | Challenge prioritization |
| | 8. How would you rate the current infrastructure's adequacy for civil aviation? | 5-point Likert scale | Infrastructure assessment |
| | 9. What environmental concerns do you have about airfield activation? | Open-ended | Environmental concerns |
| Support and Recommendations | 10. How strongly do you support the activation of Lalmonirhat Airfield? | 5-point Likert scale | Support level |
| | 11. What specific recommendations would you give to ensure successful activation? | Open-ended | Recommendations |

#### 1.2.2 Infrastructure Assessment Survey Questionnaire

| Section | Question | Response Type | Variables Measured |
|---------|----------|--------------|-------------------|
| Runway Assessment | 1. How would you rate the current condition of the runway? | 5-point scale | Runway condition |
| | 2. What is the estimated cost to upgrade the runway to meet civil aviation standards? | Numeric with ranges | Runway upgrade cost |
| | 3. What specific improvements are needed for the runway? | Checklist with details | Runway improvement needs |
| Terminal Facilities | 4. Rate the adequacy of existing structures for conversion to passenger terminals | 5-point scale | Terminal conversion potential |
| | 5. What is the estimated passenger capacity the terminal could handle after upgrades? | Numeric ranges | Passenger capacity |
| | 6. What essential terminal facilities are missing entirely? | Checklist | Terminal gaps |
| Navigation and Safety | 7. What navigation aids need to be installed? | Checklist with details | Navigation requirements |
| | 8. Rate the complexity of integrating the airfield into existing air traffic control systems | 5-point scale | ATC integration complexity |
| | 9. What safety features must be prioritized? | Ranking | Safety priorities |
| Cost and Timeline | 10. What is your estimate of total infrastructure investment required? | Numeric ranges | Total investment needed |
...
### 3.3 Economic Impact Assessment (n=100)
...
#### 4.1.2 Estimated Flight Traffic Analysis
